...
import { StepBranchInfo } from "../../components/outlet/StepBranchInfo";
import { StepLocation } from "../../components/outlet/StepLocation";
import { StepOperational } from "../../components/outlet/StepOperational";
import { StepCompliance } from "../../components/outlet/StepCompliance";
  ...
  return (
    <div className="bg-white rounded-2xl border border-brand-border shadow-sm overflow-hidden flex min-h-[600px] h-[calc(100vh-12rem)]">
      ...
      <div className="w-1/3 max-w-[320px] bg-brand-bg border-r border-brand-border p-8 hidden md:block overflow-y-auto">
        <h2 className="text-lg font-bold text-brand-dark mb-8">
          Create Branch
        </h2>
