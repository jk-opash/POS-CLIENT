export default function PosAdminBadge({
  variant = "default",
  children,
  dot,
  ...props
  ...
  const variantStyles = {
    ...
    success:
      "bg-brand-successLight/80 text-brand-success border-brand-success/20",
    warning:
      "bg-brand-warningLight/80 text-brand-warning border-brand-warning/20",
