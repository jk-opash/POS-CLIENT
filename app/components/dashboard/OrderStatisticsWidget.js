    ...
    <Card padding="md">
      ...
      <div className="grid grid-cols-2 gap-8 py-2">
        <div className="border-l-[3px] border-brand-success pl-4">
          <div className="text-[28px] text-brand-dark font-black leading-tight tracking-tight mb-1">
            {successOrders}
          </div>
          <div className="text-[11px] text-brand-muted font-bold uppercase tracking-wider">
            Success Order
          </div>
        </div>
        ...
        <div className="border-l-[3px] border-brand-warning pl-4">
          <div className="text-[28px] text-brand-dark font-black leading-tight tracking-tight mb-1">
            {averageTableTime}{" "}
            <span className="text-base text-brand-placeholder font-medium">
              mins
            </span>
          </div>
          <div className="text-[11px] text-brand-muted font-bold uppercase tracking-wider">
