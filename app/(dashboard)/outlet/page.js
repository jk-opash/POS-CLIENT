                ...
                >
                  {isChecked ? (
                    <CheckSquare
                      size={14}
                      className={
                        isDefault ? "text-brand-muted" : "text-brand-primary"
                      }
                    />
                  ) : (
                    <Square size={14} className="text-brand-muted" />
                  )}
...
const CircularProgress = ({ value, max, colorClass, icon: Icon, label }) => {
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2.5 bg-white border border-brand-border rounded-xl shadow-sm">
      ...
      <div>
        ...
        <p className="text-xl font-black text-brand-dark leading-none mt-0.5">
          {value}{" "}
    ...
    <div className="flex flex-col bg-brand-bg font-sans">
      <main className="flex-1 px-6 py-6">
        <div className=" mx-auto space-y-6">
              ...
              <button
                ...
                className={cn(
                  ...
                  activeTab === "outlets"
                    ...
                    : "border-transparent text-brand-muted hover:border-brand-primary/50 hover:text-brand-dark",
                )}
              >
          ...
          {activeTab === "outlets" && (
            <Card padding="none">
              <CardHeader className="pt-5 px-5 pb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-brand-border">
                      ...
                      >
                        ...
                        <TableCell>
                          <div className="flex items-center gap-1.5 text-brand-dark">
                            <MapPin className="h-3.5 w-3.5 text-brand-muted shrink-0" />
                            <span>
                        ...
                        <TableCell>
                          <div className="space-y-1">
                            {b.contact && (
                              <div className="text-xs text-brand-dark flex items-center gap-1.5">
                  ...
                  {teamMembers.length > 0 ? (
                    teamMembers.map((member, idx) => (
                      ...
                      >
                        ...
                        <TableCell>
                          <div className="inline-flex items-center gap-1.5 text-xs font-medium px-2 py-1 rounded-md bg-brand-light text-brand-dark border border-brand-border">
                          ...
                          <div className="flex items-center justify-end gap-2">
                            ...
                            <Button
                              ...
                              className={
                                ...
                                member.status === "active" ||
                                member.active
                                  ? "h-8 px-2 text-xs text-brand-warning border-brand-warning/30 hover:bg-brand-warning/10"
                                  : "h-8 px-2 text-xs text-brand-success border-brand-success/30 hover:bg-brand-success/10"
                              }
                            >
                            ...
                            <Button
                              ...
                              className="h-8 px-2 text-xs text-brand-danger hover:bg-brand-danger/10 hover:text-brand-danger"
                            >
