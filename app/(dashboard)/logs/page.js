...
const MOCK_LOGS = [
  {
    id: "LOG-8902",
    time: "28 Jul, 16:45:21",
    user: "Rahul Sharma",
    role: "Cashier",
    type: "Transaction",
    action: "Order Voided",
    details: "Voided Order #1042 (₹ 450). Reason: Customer walked out.",
    terminal: "Bandra - POS 1",
    severity: "critical",
  },
  {
    id: "LOG-8901",
    time: "28 Jul, 16:30:05",
    user: "Amit Patel",
    role: "Manager",
    type: "Settings",
    action: "Tax Config Changed",
    details: 'Updated "Beverages" GST rate from 5% to 18%.',
    terminal: "Web Dashboard",
    severity: "warning",
  },
  {
    id: "LOG-8900",
    time: "28 Jul, 16:15:44",
    user: "Neha Gupta",
    role: "Cashier",
    type: "Transaction",
    action: "Manual Discount",
    details: "Applied 50% custom discount on Order #1038.",
    terminal: "Andheri - POS 2",
    severity: "critical",
  },
  {
    id: "LOG-8899",
    time: "28 Jul, 15:50:10",
    user: "System",
    role: "Automated",
    type: "System",
    action: "End of Day Sync",
    details: "Successfully synced 452 offline orders to cloud.",
    terminal: "Server",
    severity: "info",
  },
  {
    id: "LOG-8898",
    time: "28 Jul, 15:22:00",
    user: "Rahul Sharma",
    role: "Cashier",
    type: "Cash",
    action: "Drawer Opened",
    details: "Cash drawer opened (No Sale) via terminal button.",
    terminal: "Bandra - POS 1",
    severity: "warning",
  },
  {
    id: "LOG-8897",
    time: "28 Jul, 14:10:30",
    user: "Sneha Rao",
    role: "Admin",
    type: "Authentication",
    action: "Login Success",
    details: "Successful login via IP 192.168.1.45",
    terminal: "Web Dashboard",
    severity: "info",
  },
  {
    id: "LOG-8896",
    time: "28 Jul, 13:45:12",
    user: "Unknown",
    role: "Unknown",
    type: "Authentication",
    action: "Failed Login",
    details: '3 failed login attempts for user "amit.p@restro.com"',
    terminal: "Mobile App",
    severity: "critical",
  },
  {
    id: "LOG-8895",
    time: "28 Jul, 12:30:00",
    user: "Amit Patel",
    role: "Manager",
    type: "Transaction",
    action: "Refund Issued",
    details: "Refunded ₹ 1250 for Order #0988 to Credit Card.",
    terminal: "Bandra - POS 1",
    severity: "warning",
  },
  {
    id: "LOG-8894",
    time: "28 Jul, 10:15:00",
    user: "Neha Gupta",
    role: "Cashier",
    type: "Authentication",
    action: "Shift Started",
    details: "Clocked in. Opening float declared: ₹ 5000.",
    terminal: "Andheri - POS 2",
    severity: "info",
  },
  {
    id: "LOG-8893",
    time: "28 Jul, 09:05:00",
    user: "System",
    role: "Automated",
    type: "Menu",
    action: "Menu Synced",
    details: "Zomato/Swiggy menu items & prices updated.",
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 flex-1 flex flex-col overflow-hidden">
          ...
          <div className="p-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
            <div className="flex gap-2">
              {["All", "Transaction", "Authentication", "Cash", "Settings"].map(
                (tab) => (
                  <button
                    key={tab}
          ...
          <div className="flex-1 overflow-y-auto">
            <table className="w-full text-left text-sm whitespace-nowrap">
              <thead className="bg-slate-50/80 sticky top-0 z-10 border-b border-slate-100">
                <tr>
                  <th className="py-4 px-6 font-bold text-xs text-slate-500 uppercase tracking-wider">
                    Timestamp / ID
                  </th>
                  <th className="py-4 px-6 font-bold text-xs text-slate-500 uppercase tracking-wider">
                    User
                  ...
                  <th className="py-4 px-6 font-bold text-xs text-slate-500 uppercase tracking-wider text-right">
                    Severity
                  </th>
                </tr>
              </thead>
