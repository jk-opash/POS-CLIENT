...
export default function ReportsPage() {
  ...
  const inventoryColumns = [
    ...
    },
    {
      ...
      label: "Category",
      render: (_, row) => (
        <span className="badge badge-muted">{row.category}</span>
      ),
    },
    {
      key: "stock",
      ...
      render: (_, row) => {
        ...
        return (
          <span
            style={{
              fontWeight: 600,
              color: isOut ? "#f43f5e" : isLow ? "#f59e0b" : "#10b981",
            }}
          >
    ...
    },
    {
      ...
      render: (_, row) => {
        ...
        return (
          <span
            className={`badge ${isOut ? "badge-rose" : isLow ? "badge-amber" : "badge-emerald"}`}
          >
    ...
    },
    {
      ...
      render: (_, row) => (
        <span style={{ fontWeight: 600 }}>
          ₹
          {(row.currentStock * row.cost).toLocaleString("en-IN", {
                ...
                >
                  {catRevenue.map((cat) => (
                    <div key={cat.id}>
                      ...
                      <MiniBar
                        value={Math.round(cat.revenue / 1000)}
                        max={Math.round(maxCatRevenue / 1000)}
                        color={cat.color || "#ff6b35"}
                      />
                    </div>
                  ))}
                      ...
                      >
                        <div
                          style={{
                            ...
                            fontWeight: 700,
                            color:
                              idx < 3 ? "#f59e0b" : "var(--color-text-muted)",
                          }}
                        >
                          {idx + 1}
                        </div>
                        <span
                          style={{
                            ...
                            height: 8,
                            borderRadius: 2,
                            background: item.vegetarian ? "#10b981" : "#f43f5e",
                            flexShrink: 0,
                          }}
                        />
              ...
              <div className="card">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-1">
                  <div style={{ textAlign: "center" }}>
                    ...
                    >
                      {
                        hours.reduce((m, h) => (h.orders > m.orders ? h : m))
                          .hour
                      }
                    </div>
                  </div>
                  ...
                  <div style={{ textAlign: "center" }}>
                    ...
                    >
                      {Math.round(
                        hours.reduce((s, h) => s + h.orders, 0) / hours.length,
                      )}
                    </div>
                  </div>
                </div>
            ...
            <div className="animate-fade-in">
              ...
              >
                ...
                <div className="card-sm">
                  ...
                  >
                    {stockAlerts.filter((i) => i.currentStock > 0).length}
                  </div>
                  <div
                    style={{
                      fontSize: 11,
                ...
                <div className="card-sm">
                  <div
                    style={{ fontSize: 22, fontWeight: 700, color: "#f43f5e" }}
                  >
                    {stockAlerts.filter((i) => i.currentStock <= 0).length}
                  </div>
                  <div
                ...
                <div className="card-sm">
                  ...
                  >
                    ₹
                    {inventory
                      .reduce((s, i) => s + i.currentStock * i.cost, 0)
