          ...
          <div className="space-y-6 pb-12">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-1 justify-end flex-wrap items-center gap-3">
                <div className="flex flex-1 items-center gap-2 px-4 py-2 bg-white border border-brand-border rounded-lg max-w-md shadow-sm transition-colors focus-within:border-brand-border">
                  ...
                  <input
                    className="w-full text-brand-primary outline-none text-brand-dark placeholder:text-brand-muted/70"
            ...
            <div className="rounded-2xl border border-brand-border/80 bg-white/70 backdrop-blur-lg shadow-sm overflow-hidden flex flex-col">
                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-brand-border bg-brand-bg/80 text-[11px] font-black text-brand-muted/70 uppercase tracking-wider">
                      ...
                      <th
                        className="py-3.5 px-6 text-right cursor-pointer hover:text-brand-dark transition-colors"
                  ...
                  <tbody className="divide-y divide-brand-border/60 bg-white text-sm font-medium text-brand-dark">
                    {staffPerformanceLoading ? (
                      <tr>
                      ...
                      paginatedRecords.map((staff, idx) => (
                        <tr
                          key={staff.id}
                          className="group hover:bg-brand-bg/50 transition-all duration-200"
                        >
                          <td className="py-3.5 px-6 whitespace-nowrap">
                            <div className="flex items-center gap-3">
                              <div className="w-8 h-8 rounded-full bg-brand-light flex items-center justify-center text-brand-dark font-bold border border-brand-border/80">
                          ...
                          <td className="py-3.5 px-6 text-right whitespace-nowrap">
                            <div className="flex items-center justify-end gap-1.5 text-brand-dark">
                              <UtensilsCrossed className="w-3.5 h-3.5 text-brand-muted/70 opacity-60" />
              ...
              {!staffPerformanceLoading && totalPages > 1 && (
                <div className="border-t border-brand-border/60 p-4 bg-brand-bg/50">
                  <PosAdminPagination
