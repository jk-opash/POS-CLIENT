...
export function Header({ onMenuClick }) {
  ...
  return (
    <>
      <header className="sticky top-0 flex h-16 w-full items-center justify-between border-b border-white/60 bg-white/70 px-4 md:px-8 backdrop-blur-xl shadow-[0_4px_30px_rgb(0,0,0,0.03)]">
          ...
          <div className="relative" ref={profileDropdownRef}>
            ...
            >
              ...
              <div className="hidden sm:flex flex-col items-start">
                ...
                <div className="mt-0.5 inline-flex items-center justify-center rounded bg-brand-primary px-1.5 py-[2px] shadow-sm">
